		...
		for num,index in enumerate(ids):
			...
			if os.path.exists(json_file):
				...
				for obj in objs:
					...
					annotation_msg.append(one_ann_msg)
					annotation_id += 1
			one_image_msg = {"file_name": filename + ".png",
							 "height": int(height),
							 "width": int(width),
							 "id": int(num)
							 }
...
def demo():
	...
	# / home / wxy / hirain / VOCdevkit / VOC2007 / ImageSets / Main /
	converter = voc2coco('/home/wxy/hirain/VOCdevkit', '2007')
